...
| 子文档 | 内容 |
|------|------|
| [01_concept-and-storage.md](knowledge-model/01_concept-and-storage.md) | 三层概念模型 + opc-knowledge/ 目录布局 |
| [02_metadata-files.md](knowledge-model/02_metadata-files.md) | `.md frontmatter` / `.opc-knowledge.json` / `.opc-knowledge.idx` |
| [03_versioning.md](knowledge-model/03_versioning.md) | version 字段 + `min_version` 校验 |
| [04_node-driven.md](knowledge-model/04_node-driven.md) | node frontmatter 的 input/output 声明 + 执行流程 |
| [05_smart-reuse.md](knowledge-model/05_smart-reuse.md) | 创建 vs 更新的判定 |
...
- [知识 API](02_knowledge-api-overview.md) — 8 个 MCP 工具完整规范
