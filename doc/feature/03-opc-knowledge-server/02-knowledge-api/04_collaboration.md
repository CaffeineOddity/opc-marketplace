...
- [../../02-opc-state-server/01-intent-analysis/00_overview.md](../../02-opc-state-server/01-intent-analysis/00_overview.md) — 流程状态机 + 方法论文档协作
- [../../02-opc-state-server/04-node/00_overview.md](../../02-opc-state-server/04-node/00_overview.md) — 节点定义中的 knowledge input/output 声明
- [../../02-opc-state-server/02-pipeline/00_overview.md](../../02-opc-state-server/02-pipeline/00_overview.md) — 管线创建与状态管理
