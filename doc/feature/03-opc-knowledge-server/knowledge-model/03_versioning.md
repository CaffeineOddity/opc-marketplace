...
- [../knowledge-api/02_core-tools.md](../knowledge-api/02_core-tools.md) — `opc_knowledge_get_batch` 接口
- [../../02-opc-state-server/node/02_field-spec.md](../../02-opc-state-server/node/02_field-spec.md) — node input 字段
