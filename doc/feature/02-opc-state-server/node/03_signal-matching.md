...
- **语义匹配 + Scenario 加权** — Claude 在主循环执行，详见 [../phase/02_node-selection.md](../phase/02_node-selection.md)
...
- [../phase/02_node-selection.md](../phase/02_node-selection.md) — Claude 匹配排序与置信度
- [../phase/03_scenarios.md](../phase/03_scenarios.md) — Scenario 配方
