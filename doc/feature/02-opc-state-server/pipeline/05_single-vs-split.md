...
判定由 `opc_task_analysis_complete` 路由完成，详见 [intent-analysis task-analysis](../intent-analysis/06_task-analysis.md)。
...
- [../intent-analysis/07_task-decomposition.md](../intent-analysis/07_task-decomposition.md) — 拆分规则
