...
| 子文档 | 内容 |
|------|------|
| [walkthrough/01_user-input.md](walkthrough/01_user-input.md) | 第一步：用户输入 + 知识库初始状态 |
| [walkthrough/02_flow-startup.md](walkthrough/02_flow-startup.md) | 第二步：流程启动 + 意图分析 + 任务分析 |
| [walkthrough/03_brief-to-create.md](walkthrough/03_brief-to-create.md) | 第三步：brief 生成 + pipeline_create + knowledge_open |
| [walkthrough/04_phase-04-implement-design.md](walkthrough/04_phase-04-implement-design.md) | 第四步：Phase 04-implement-design（api-design + database-schema）|
| [walkthrough/05_phase-05-implement.md](walkthrough/05_phase-05-implement.md) | 第五步：Phase 05-implement（含反思调整）|
| [walkthrough/06_phase-06-testing.md](walkthrough/06_phase-06-testing.md) | 第六步：Phase 06-testing |
| [walkthrough/07_pipeline-complete.md](walkthrough/07_pipeline-complete.md) | 第七、八步：pipeline_complete + 最终知识库 + MCP 调用汇总 |
...
- [02_test-overview.md](02_test-overview.md) — 10 个测试场景从简单到复杂
- [../02-opc-state-server/01_intent-analysis-overview.md](../02-opc-state-server/01_intent-analysis-overview.md) — 流程状态机
- [../02-opc-state-server/02_pipeline-overview.md](../02-opc-state-server/02_pipeline-overview.md) — 管线模型
- [../02-opc-state-server/03_phase-overview.md](../02-opc-state-server/03_phase-overview.md) — 阶段模型
- [../02-opc-state-server/04_node-overview.md](../02-opc-state-server/04_node-overview.md) — 节点模型
- [../03-opc-knowledge-server/01_knowledge-model-overview.md](../03-opc-knowledge-server/01_knowledge-model-overview.md) — 知识模型
