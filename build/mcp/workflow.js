 ...
 */
export function readAllWorkflows(cwd) {
 ...
 */
export function matchWorkflow(taskDescription, workflows) {
 ...
 */
export function buildStagesFromWorkflow(workflow) {
    const stages = {};
 ...
 */
export function buildStagesAuto(taskDescription) {
    const lowerTask = taskDescription.toLowerCase();
    const stages = {};
 ...
 */
export function buildDefaultGates(stages) {
    const gates = [];
    if (stages.product) {
        gates.push({
